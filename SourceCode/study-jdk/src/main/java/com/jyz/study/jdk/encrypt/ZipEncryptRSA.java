package com.jyz.study.jdk.encrypt;
 ...
 *	http://www.blogjava.net/zhaochengming/archive/2007/09/03/142396.html
 */
...
//		ZipEncrypt.encryptZip(srcPath, destZip, keyfile);
		...
		ZipEncryptRSA.encryptZip("F:\\test", "F:\\test.zip", "F:\\public.key");

		ZipEncryptRSA.decryptUnzip("F:\\test.zip", "F:\\test2", ZipEncryptRSA.getKey("F:\\public.key"));
	}
}
