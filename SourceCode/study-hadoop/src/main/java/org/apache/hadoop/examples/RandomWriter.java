...
public class RandomWriter extends Configured implements Tool {
    ...
    public static final String BYTES_PER_MAP = "com.jyz.study.hadoop.hbase.mapreduce.randomwriter.bytespermap";
    public static final String MAPS_PER_HOST = "com.jyz.study.hadoop.hbase.mapreduce.randomwriter.mapsperhost";
