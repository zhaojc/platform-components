...
public class DistributedPentomino extends Configured implements Tool {
	...
	public void setup(Context context) {
	    ...
	    pent = (Pentomino) ReflectionUtils.newInstance(conf.getClass(Pentomino.CLASS, OneSidedPentomino.class), conf);
	...
	PrintWriter file = new PrintWriter(new OutputStreamWriter(new BufferedOutputStream(fs.create(input), 64 * 1024),
		Charsets.UTF_8));
