...
public class TeraInputFormat extends FileInputFormat<Text, Text> {
    ...
    private static final String NUM_PARTITIONS = "com.jyz.study.hadoop.hbase.mapreduce.terasort.num.partitions";
    private static final String SAMPLE_SIZE = "com.jyz.study.hadoop.hbase.mapreduce.terasort.partitions.sample";
