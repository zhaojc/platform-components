...
public class DatePreproccess {
    ...
    public static final String[] TABLE_NAME = { "user", "tradeDetails",
	    "userTradeDetails" };
	...
	HBaseUtils.addData("user", tableName, new String[] { "age" },
		new String[] { "20" });
	...
	for (int i = 1; i <= 5; i++) {
	    HBaseUtils.addData("user" + i, tableName,
		    new String[] { "describe" }, new String[] { "abc" + i });
	}
	HBaseUtils.getResultScann(tableName);
