...
public class DataJoinUseNewApi {
	...
	protected TaggedMapOutput generateTaggedMapOutput(Text value) {
	...
	protected TaggedMapOutput combine(Text[] tags, TaggedWritable[] values) {
	    String joinedStr = "";
	    TaggedWritable tw = values[0];
	...
	public void readFields(DataInput in) throws IOException {
		...
		try {
		    this.data = (Text) ReflectionUtils.newInstance(Class
	...
	FileInputFormat.addInputPath(job, new Path(
		"hdfs://200master:9000/user/root/input2"));
