...
public class ControlledJob {
    ...
    private ExtensionParmeters extensionParmeters;
	...
	if (extendable != null) {
	    extendable.doExtend(extensionParmeters);
	}
    }
    ...
    public ExtensionParmeters getExtensionParmeters() {
	return extensionParmeters;
    }

    public void setExtensionParmeters(ExtensionParmeters extensionParmeters) {
	this.extensionParmeters = extensionParmeters;
    }
