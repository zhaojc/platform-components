...
public class PropertiesParser {
    ...
    public String[] getPropertyGroups(String prefix) {
        ...
        Set<String> groups = new HashSet<String>(10);
        ...
        while (keys.hasMoreElements()) {
            ...
            if (key.startsWith(prefix)) {
            	...
            	int offset = key.indexOf('.', prefix.length());
                String groupName = key.substring(prefix.length(), offset);
