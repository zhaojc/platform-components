 ...
 */
public class AdqNumberUtils extends org.apache.commons.lang.math.NumberUtils {

    /**
     * compare the number value
     */
    ...
    public static BigDecimal toBigDecimal(Number number) {
        ...
        throw new IllegalStateException("Unsupported number[" + number + "].");
    }
    ...
    public static <T extends Number> T convertNumberToTargetClass(Number number, Class<T> targetClass)
        ...
        AdqAssert.notNull(number, "Number must not be null");
        AdqAssert.notNull(targetClass, "Target class must not be null");
    ...
    public static <T extends Number> T parseNumber(String text, Class<T> targetClass) {
        AdqAssert.notNull(text, "Text must not be null");
        AdqAssert.notNull(targetClass, "Target class must not be null");
        String trimmed = AdqStringUtils.trimAllWhitespace(text);
    ...
    public static <T extends Number> T parseNumber(String text, Class<T> targetClass, NumberFormat numberFormat) {
        if (numberFormat != null) {
            ...
            try {
                Number number = numberFormat.parse(AdqStringUtils.trimAllWhitespace(text));
