...
public abstract class AdqStringUtils extends StringUtils {
    ...
    public static String toLanguageTag(Locale locale) {
        return locale.getLanguage() + (isNotEmpty(locale.getCountry()) ? "-" + locale.getCountry() : "");
    }
    ...
    public static String[] concatenateStringArrays(String[] array1, String[] array2) {
        if (AdqArrayUtils.isEmpty(array1)) {
            return array2;
        }
        if (AdqArrayUtils.isEmpty(array2)) {
            return array1;
        }
    ...
    public static String collectionToDelimitedString(Collection<?> coll, String delim, String prefix, String suffix) {
        if (AdqCollectionUtils.isEmpty(coll)) {
            return "";
        }
        StringBuilder sb = new StringBuilder();
    ...
    public static String arrayToDelimitedString(Object[] arr, String delim) {
        if (AdqArrayUtils.isEmpty(arr)) {
            return "";
        }
        if (arr.length == 1) {
            return AdqObjectUtils.nullSafeToString(arr[0]);
        }
        StringBuilder sb = new StringBuilder();
    ...
    public static String pad(String source, PadType type, int targetLength, char padChar) {
    ...
    private static void notNegative(int length) {
        if (length < 0) {
            throw new RuntimeException("The length must be large than 0 not " + length + "!");
        }
    }

    public static String format(String pathern, String source, Map<String, String> args) {
        StringBuffer sb = new StringBuffer();
        Matcher matcher = Pattern.compile(pathern, Pattern.DOTALL).matcher(source);
        int lastIndex = 0;
        while (matcher.find()) {
